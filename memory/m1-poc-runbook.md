...
- **可用的本地跑法**（本地无 PG 时）：
  `NEWAPI_API_KEY=<key> mvn -ntp -pl app-server org.codehaus.mojo:exec-maven-plugin:3.5.0:java -Dexec.classpathScope=test -Dexec.mainClass=com.apeloa.agent.ApeloaAgentApplication -Dspring.profiles.active=poc,test`
